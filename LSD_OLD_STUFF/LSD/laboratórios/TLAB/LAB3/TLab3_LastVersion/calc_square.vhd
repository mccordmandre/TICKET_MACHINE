...
begin
    x_squared <= 
        ...
        "00011001" when x = "0101" else  -- 5^2
        "00100100" when x = "0110" else  -- 6^2
        "00110001" when x = "0111" else  -- 7^2
        "01000000" when x = "1000" else  -- 8^2
        "01010001" when x = "1001" else  -- 9^2
        "01100100" when x = "1010" else  -- 10^2
        "01111001" when x = "1011" else  -- 11^2
        "10010000" when x = "1100" else  -- 12^2
        "10101001" when x = "1101" else  -- 13^2
        "11000100" when x = "1110" else  -- 14^2
        "11100001" when x = "1111" else  -- 15^2
