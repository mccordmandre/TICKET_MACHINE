...
begin
    ...
    rom_out <= "00000" WHEN addr = "0000" ELSE -- Q1=0, Q0=0, Start=0, Step=0
               "00000" WHEN addr = "0001" ELSE -- Q1=0, Q0=0, Start=0, Step=1

    -- D=01: Soma apagada, Step ainda inativo
               "01110" WHEN addr = "0010" ELSE -- Q1=0, Q0=0, Start=1, Step=0
               "01010" WHEN addr = "0011" ELSE -- Q1=0, Q0=0, Start=1, Step=1

    -- D=00: Apresenta a soma anterior
               "00000" WHEN addr = "0100" ELSE -- Q1=0, Q0=1, Start=0, Step=0
               "00000" WHEN addr = "0101" ELSE -- Q1=0, Q0=1, Start=0, Step=1

    -- D=10: Mostra o valor de X²
               "01100" WHEN addr = "0110" ELSE -- Q1=0, Q0=1, Start=1, Step=0
    ...
    -- D=00: Apresenta a soma anterior
               "00000" WHEN addr = "1100" ELSE -- Q1=1, Q0=1, Start=0, Step=0
               "00000" WHEN addr = "1101" ELSE -- Q1=1, Q0=1, Start=0, Step=1

    -- D=11: Mostra o valor da soma após X² ser somado ao registrador
               "11100" WHEN addr = "1110" ELSE -- Q1=1, Q0=1, Start=1, Step=0

    -- D=10: Mostra o valor de X²
               "10000" WHEN addr = "1111" ELSE -- Q1=1, Q0=1, Start=1, Step=1
